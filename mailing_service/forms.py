    ...
    def clean_email(self):
        ...
        if not (
            ...
            raise ValidationError(
                "Email должен оканчиваться на @gmail.com, @yandex.ru или @mail.ru"
            )
        return email
...
class MailingForm(ModelForm):
    ...
    def clean_start_time(self):
        ...
        if start_time:
            if start_time < time_now:
                raise ValidationError(
                    "Дата и время начала отправки не может быть в прошлом"
                )
        return start_time
    ...
    def clean_end_time(self):
        ...
        if end_time < time_now:
            raise ValidationError(
                "Дата и время окончания отправки не может быть в прошлом"
            )
        return end_time
